...
// GetSovereigntyCampaignsParams contains all the bound params for the get sovereignty campaigns operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_sovereignty_campaigns
...
func (o *GetSovereigntyCampaignsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetSovereigntyCampaignsParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetSovereigntyCampaignsParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSovereigntyCampaignsParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetSovereigntyCampaignsParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
