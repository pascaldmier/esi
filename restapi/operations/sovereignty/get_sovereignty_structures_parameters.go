...
// GetSovereigntyStructuresParams contains all the bound params for the get sovereignty structures operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_sovereignty_structures
...
func (o *GetSovereigntyStructuresParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetSovereigntyStructuresParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetSovereigntyStructuresParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSovereigntyStructuresParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetSovereigntyStructuresParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
