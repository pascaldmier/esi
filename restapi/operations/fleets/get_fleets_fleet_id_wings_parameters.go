...
// GetFleetsFleetIDWingsParams contains all the bound params for the get fleets fleet id wings operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_fleets_fleet_id_wings
...
func (o *GetFleetsFleetIDWingsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetFleetsFleetIDWingsParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetFleetsFleetIDWingsParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetFleetsFleetIDWingsParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetFleetsFleetIDWingsParams) bindFleetID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetFleetsFleetIDWingsParams) bindLanguage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetFleetsFleetIDWingsParams) validateLanguage(formats strfmt.Registry) error {
...
func (o *GetFleetsFleetIDWingsParams) bindToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetFleetsFleetIDWingsParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
