...
// PostFleetsFleetIDWingsParams contains all the bound params for the post fleets fleet id wings operation
// typically these are obtained from a http.Request
//
// swagger:parameters post_fleets_fleet_id_wings
...
func (o *PostFleetsFleetIDWingsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *PostFleetsFleetIDWingsParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PostFleetsFleetIDWingsParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostFleetsFleetIDWingsParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *PostFleetsFleetIDWingsParams) bindFleetID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostFleetsFleetIDWingsParams) bindToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostFleetsFleetIDWingsParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
