...
// DeleteFleetsFleetIDMembersMemberIDParams contains all the bound params for the delete fleets fleet id members member id operation
// typically these are obtained from a http.Request
//
// swagger:parameters delete_fleets_fleet_id_members_member_id
...
func (o *DeleteFleetsFleetIDMembersMemberIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *DeleteFleetsFleetIDMembersMemberIDParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteFleetsFleetIDMembersMemberIDParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteFleetsFleetIDMembersMemberIDParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *DeleteFleetsFleetIDMembersMemberIDParams) bindFleetID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteFleetsFleetIDMembersMemberIDParams) bindMemberID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteFleetsFleetIDMembersMemberIDParams) bindToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteFleetsFleetIDMembersMemberIDParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
