...
// PutFleetsFleetIDMembersMemberIDParams contains all the bound params for the put fleets fleet id members member id operation
// typically these are obtained from a http.Request
//
// swagger:parameters put_fleets_fleet_id_members_member_id
...
func (o *PutFleetsFleetIDMembersMemberIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.PutFleetsFleetIDMembersMemberIDParamsBody
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("movement", "body"))
			} else {
				res = append(res, errors.NewParseError("movement", "body", "", err))
			}
...
func (o *PutFleetsFleetIDMembersMemberIDParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PutFleetsFleetIDMembersMemberIDParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PutFleetsFleetIDMembersMemberIDParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *PutFleetsFleetIDMembersMemberIDParams) bindFleetID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PutFleetsFleetIDMembersMemberIDParams) bindMemberID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if err != nil {
		return errors.InvalidType("member_id", "path", "int32", raw)
	}
	o.MemberID = value
...
func (o *PutFleetsFleetIDMembersMemberIDParams) bindToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PutFleetsFleetIDMembersMemberIDParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
