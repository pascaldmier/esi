...
// PutFleetsFleetIDParams contains all the bound params for the put fleets fleet id operation
// typically these are obtained from a http.Request
//
// swagger:parameters put_fleets_fleet_id
...
func (o *PutFleetsFleetIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.PutFleetsFleetIDParamsBody
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("newSettings", "body"))
			} else {
				res = append(res, errors.NewParseError("newSettings", "body", "", err))
			}
...
func (o *PutFleetsFleetIDParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PutFleetsFleetIDParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PutFleetsFleetIDParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *PutFleetsFleetIDParams) bindFleetID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PutFleetsFleetIDParams) bindToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PutFleetsFleetIDParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
