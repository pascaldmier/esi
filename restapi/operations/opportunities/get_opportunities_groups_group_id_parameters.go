...
// GetOpportunitiesGroupsGroupIDParams contains all the bound params for the get opportunities groups group id operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_opportunities_groups_group_id
...
func (o *GetOpportunitiesGroupsGroupIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetOpportunitiesGroupsGroupIDParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetOpportunitiesGroupsGroupIDParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetOpportunitiesGroupsGroupIDParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetOpportunitiesGroupsGroupIDParams) bindGroupID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetOpportunitiesGroupsGroupIDParams) bindLanguage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetOpportunitiesGroupsGroupIDParams) validateLanguage(formats strfmt.Registry) error {
...
func (o *GetOpportunitiesGroupsGroupIDParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
