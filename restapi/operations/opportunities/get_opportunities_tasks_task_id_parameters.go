...
// GetOpportunitiesTasksTaskIDParams contains all the bound params for the get opportunities tasks task id operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_opportunities_tasks_task_id
...
func (o *GetOpportunitiesTasksTaskIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetOpportunitiesTasksTaskIDParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetOpportunitiesTasksTaskIDParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetOpportunitiesTasksTaskIDParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetOpportunitiesTasksTaskIDParams) bindTaskID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if err != nil {
		return errors.InvalidType("task_id", "path", "int32", raw)
	}
	o.TaskID = value
...
func (o *GetOpportunitiesTasksTaskIDParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
