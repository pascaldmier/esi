...
// GetCharactersCharacterIDSearchParams contains all the bound params for the get characters character id search operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_characters_character_id_search
...
func (o *GetCharactersCharacterIDSearchParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetCharactersCharacterIDSearchParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetCharactersCharacterIDSearchParams) bindCategories(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
	...
	for i, categoriesIV := range categoriesIC {
		...
		if err := validate.Enum(fmt.Sprintf("%s.%v", "categories", i), "query", categoriesI, []interface{}{"agent", "alliance", "character", "constellation", "corporation", "faction", "inventorytype", "region", "solarsystem", "station", "structure", "wormhole"}); err != nil {
			return err
		}
...
func (o *GetCharactersCharacterIDSearchParams) validateCategories(formats strfmt.Registry) error {
	...
	if err := validate.MaxItems("categories", "query", categoriesSize, 12); err != nil {
		return err
	}
...
func (o *GetCharactersCharacterIDSearchParams) bindCharacterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetCharactersCharacterIDSearchParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetCharactersCharacterIDSearchParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetCharactersCharacterIDSearchParams) bindLanguage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetCharactersCharacterIDSearchParams) validateLanguage(formats strfmt.Registry) error {
...
func (o *GetCharactersCharacterIDSearchParams) bindSearch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetCharactersCharacterIDSearchParams) validateSearch(formats strfmt.Registry) error {
...
func (o *GetCharactersCharacterIDSearchParams) bindStrict(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetCharactersCharacterIDSearchParams) bindToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetCharactersCharacterIDSearchParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
