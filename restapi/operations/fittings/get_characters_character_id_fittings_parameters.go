...
// GetCharactersCharacterIDFittingsParams contains all the bound params for the get characters character id fittings operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_characters_character_id_fittings
...
func (o *GetCharactersCharacterIDFittingsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetCharactersCharacterIDFittingsParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetCharactersCharacterIDFittingsParams) bindCharacterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetCharactersCharacterIDFittingsParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetCharactersCharacterIDFittingsParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetCharactersCharacterIDFittingsParams) bindToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetCharactersCharacterIDFittingsParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
