...
// GetInsurancePricesParams contains all the bound params for the get insurance prices operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_insurance_prices
...
func (o *GetInsurancePricesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetInsurancePricesParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetInsurancePricesParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetInsurancePricesParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetInsurancePricesParams) bindLanguage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetInsurancePricesParams) validateLanguage(formats strfmt.Registry) error {
...
func (o *GetInsurancePricesParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
