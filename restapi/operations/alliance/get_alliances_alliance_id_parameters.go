...
// GetAlliancesAllianceIDParams contains all the bound params for the get alliances alliance id operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_alliances_alliance_id
...
func (o *GetAlliancesAllianceIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetAlliancesAllianceIDParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAlliancesAllianceIDParams) bindAllianceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAlliancesAllianceIDParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAlliancesAllianceIDParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetAlliancesAllianceIDParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
