...
// GetAlliancesAllianceIDCorporationsParams contains all the bound params for the get alliances alliance id corporations operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_alliances_alliance_id_corporations
...
func (o *GetAlliancesAllianceIDCorporationsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetAlliancesAllianceIDCorporationsParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAlliancesAllianceIDCorporationsParams) bindAllianceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAlliancesAllianceIDCorporationsParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAlliancesAllianceIDCorporationsParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetAlliancesAllianceIDCorporationsParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
