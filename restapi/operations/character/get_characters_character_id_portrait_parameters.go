...
// GetCharactersCharacterIDPortraitParams contains all the bound params for the get characters character id portrait operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_characters_character_id_portrait
...
func (o *GetCharactersCharacterIDPortraitParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetCharactersCharacterIDPortraitParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetCharactersCharacterIDPortraitParams) bindCharacterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetCharactersCharacterIDPortraitParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetCharactersCharacterIDPortraitParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetCharactersCharacterIDPortraitParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
