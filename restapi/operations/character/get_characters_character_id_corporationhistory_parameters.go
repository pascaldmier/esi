...
// GetCharactersCharacterIDCorporationhistoryParams contains all the bound params for the get characters character id corporationhistory operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_characters_character_id_corporationhistory
...
func (o *GetCharactersCharacterIDCorporationhistoryParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetCharactersCharacterIDCorporationhistoryParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetCharactersCharacterIDCorporationhistoryParams) bindCharacterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetCharactersCharacterIDCorporationhistoryParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetCharactersCharacterIDCorporationhistoryParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetCharactersCharacterIDCorporationhistoryParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
