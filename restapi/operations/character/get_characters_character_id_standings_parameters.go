...
// GetCharactersCharacterIDStandingsParams contains all the bound params for the get characters character id standings operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_characters_character_id_standings
...
func (o *GetCharactersCharacterIDStandingsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetCharactersCharacterIDStandingsParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetCharactersCharacterIDStandingsParams) bindCharacterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetCharactersCharacterIDStandingsParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetCharactersCharacterIDStandingsParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetCharactersCharacterIDStandingsParams) bindToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetCharactersCharacterIDStandingsParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
