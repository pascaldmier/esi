...
// GetUniverseTypesTypeIDParams contains all the bound params for the get universe types type id operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_universe_types_type_id
...
func (o *GetUniverseTypesTypeIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
	...
	rTypeID, rhkTypeID, _ := route.Params.GetOK("type_id")
...
func (o *GetUniverseTypesTypeIDParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetUniverseTypesTypeIDParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetUniverseTypesTypeIDParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetUniverseTypesTypeIDParams) bindLanguage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetUniverseTypesTypeIDParams) validateLanguage(formats strfmt.Registry) error {
...
func (o *GetUniverseTypesTypeIDParams) bindTypeID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if err != nil {
		return errors.InvalidType("type_id", "path", "int32", raw)
	}
	o.TypeID = value
...
func (o *GetUniverseTypesTypeIDParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
