...
// GetUniverseSystemsSystemIDParams contains all the bound params for the get universe systems system id operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_universe_systems_system_id
...
func (o *GetUniverseSystemsSystemIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
	...
	rSystemID, rhkSystemID, _ := route.Params.GetOK("system_id")
...
func (o *GetUniverseSystemsSystemIDParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetUniverseSystemsSystemIDParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetUniverseSystemsSystemIDParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetUniverseSystemsSystemIDParams) bindLanguage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetUniverseSystemsSystemIDParams) validateLanguage(formats strfmt.Registry) error {
...
func (o *GetUniverseSystemsSystemIDParams) bindSystemID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if err != nil {
		return errors.InvalidType("system_id", "path", "int32", raw)
	}
	o.SystemID = value
...
func (o *GetUniverseSystemsSystemIDParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
