...
// PostUniverseNamesParams contains all the bound params for the post universe names operation
// typically these are obtained from a http.Request
//
// swagger:parameters post_universe_names
...
func (o *PostUniverseNamesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *PostUniverseNamesParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PostUniverseNamesParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostUniverseNamesParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *PostUniverseNamesParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
