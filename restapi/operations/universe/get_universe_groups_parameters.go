...
// GetUniverseGroupsParams contains all the bound params for the get universe groups operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_universe_groups
...
func (o *GetUniverseGroupsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetUniverseGroupsParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetUniverseGroupsParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetUniverseGroupsParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetUniverseGroupsParams) bindPage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetUniverseGroupsParams) validatePage(formats strfmt.Registry) error {
...
func (o *GetUniverseGroupsParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
