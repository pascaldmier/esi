...
// GetUniverseCategoriesParams contains all the bound params for the get universe categories operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_universe_categories
...
func (o *GetUniverseCategoriesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetUniverseCategoriesParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetUniverseCategoriesParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetUniverseCategoriesParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetUniverseCategoriesParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
