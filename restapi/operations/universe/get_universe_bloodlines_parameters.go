...
// GetUniverseBloodlinesParams contains all the bound params for the get universe bloodlines operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_universe_bloodlines
...
func (o *GetUniverseBloodlinesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetUniverseBloodlinesParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetUniverseBloodlinesParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetUniverseBloodlinesParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetUniverseBloodlinesParams) bindLanguage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetUniverseBloodlinesParams) validateLanguage(formats strfmt.Registry) error {
...
func (o *GetUniverseBloodlinesParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
