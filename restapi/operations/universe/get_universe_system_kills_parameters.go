...
// GetUniverseSystemKillsParams contains all the bound params for the get universe system kills operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_universe_system_kills
...
func (o *GetUniverseSystemKillsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetUniverseSystemKillsParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetUniverseSystemKillsParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetUniverseSystemKillsParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetUniverseSystemKillsParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
