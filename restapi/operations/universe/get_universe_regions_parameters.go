...
// GetUniverseRegionsParams contains all the bound params for the get universe regions operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_universe_regions
...
func (o *GetUniverseRegionsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetUniverseRegionsParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetUniverseRegionsParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetUniverseRegionsParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetUniverseRegionsParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
