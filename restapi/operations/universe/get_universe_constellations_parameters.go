...
// GetUniverseConstellationsParams contains all the bound params for the get universe constellations operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_universe_constellations
...
func (o *GetUniverseConstellationsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetUniverseConstellationsParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetUniverseConstellationsParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetUniverseConstellationsParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetUniverseConstellationsParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
