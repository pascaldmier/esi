...
// GetCharactersCharacterIDLocationParams contains all the bound params for the get characters character id location operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_characters_character_id_location
...
func (o *GetCharactersCharacterIDLocationParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetCharactersCharacterIDLocationParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetCharactersCharacterIDLocationParams) bindCharacterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetCharactersCharacterIDLocationParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetCharactersCharacterIDLocationParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetCharactersCharacterIDLocationParams) bindToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetCharactersCharacterIDLocationParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
