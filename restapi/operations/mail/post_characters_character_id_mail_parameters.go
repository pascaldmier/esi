...
// PostCharactersCharacterIDMailParams contains all the bound params for the post characters character id mail operation
// typically these are obtained from a http.Request
//
// swagger:parameters post_characters_character_id_mail
...
func (o *PostCharactersCharacterIDMailParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.PostCharactersCharacterIDMailParamsBody
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("mail", "body"))
			} else {
				res = append(res, errors.NewParseError("mail", "body", "", err))
			}
...
func (o *PostCharactersCharacterIDMailParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PostCharactersCharacterIDMailParams) bindCharacterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostCharactersCharacterIDMailParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostCharactersCharacterIDMailParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *PostCharactersCharacterIDMailParams) bindToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostCharactersCharacterIDMailParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
