...
// PostCharactersCharacterIDMailLabelsParams contains all the bound params for the post characters character id mail labels operation
// typically these are obtained from a http.Request
//
// swagger:parameters post_characters_character_id_mail_labels
...
func (o *PostCharactersCharacterIDMailLabelsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.PostCharactersCharacterIDMailLabelsParamsBody
...
func (o *PostCharactersCharacterIDMailLabelsParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PostCharactersCharacterIDMailLabelsParams) bindCharacterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostCharactersCharacterIDMailLabelsParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostCharactersCharacterIDMailLabelsParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *PostCharactersCharacterIDMailLabelsParams) bindToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostCharactersCharacterIDMailLabelsParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
