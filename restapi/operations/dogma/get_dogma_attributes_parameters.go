...
// GetDogmaAttributesParams contains all the bound params for the get dogma attributes operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_dogma_attributes
...
func (o *GetDogmaAttributesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetDogmaAttributesParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetDogmaAttributesParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetDogmaAttributesParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetDogmaAttributesParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
