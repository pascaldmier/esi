...
// GetIndustrySystemsParams contains all the bound params for the get industry systems operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_industry_systems
...
func (o *GetIndustrySystemsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetIndustrySystemsParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetIndustrySystemsParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetIndustrySystemsParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetIndustrySystemsParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
