...
// GetIndustryFacilitiesParams contains all the bound params for the get industry facilities operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_industry_facilities
...
func (o *GetIndustryFacilitiesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetIndustryFacilitiesParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetIndustryFacilitiesParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetIndustryFacilitiesParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetIndustryFacilitiesParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
