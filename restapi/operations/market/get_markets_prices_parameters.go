...
// GetMarketsPricesParams contains all the bound params for the get markets prices operation
// typically these are obtained from a http.Request
//
// swagger:parameters get_markets_prices
...
func (o *GetMarketsPricesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetMarketsPricesParams) bindXUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetMarketsPricesParams) bindDatasource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetMarketsPricesParams) validateDatasource(formats strfmt.Registry) error {
...
func (o *GetMarketsPricesParams) bindUserAgent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
