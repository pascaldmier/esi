...
// WithXUserAgent adds the xUserAgent to the get incursions params
func (o *GetIncursionsParams) WithXUserAgent(xUserAgent *string) *GetIncursionsParams {
	o.SetXUserAgent(xUserAgent)
	return o
}

// SetXUserAgent adds the xUserAgent to the get incursions params
func (o *GetIncursionsParams) SetXUserAgent(xUserAgent *string) {
...
// WithUserAgent adds the userAgent to the get incursions params
func (o *GetIncursionsParams) WithUserAgent(userAgent *string) *GetIncursionsParams {
	o.SetUserAgent(userAgent)
	return o
}

// SetUserAgent adds the userAgent to the get incursions params
func (o *GetIncursionsParams) SetUserAgent(userAgent *string) {
