...
/*
PutCorporationsCorporationIDStructuresStructureID updates structure vulnerability schedule
...
*/
func (a *Client) PutCorporationsCorporationIDStructuresStructureID(params *PutCorporationsCorporationIDStructuresStructureIDParams, authInfo runtime.ClientAuthInfoWriter) (*PutCorporationsCorporationIDStructuresStructureIDNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewPutCorporationsCorporationIDStructuresStructureIDParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "put_corporations_corporation_id_structures_structure_id",
		Method:             "PUT",
		PathPattern:        "/corporations/{corporation_id}/structures/{structure_id}/",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{""},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &PutCorporationsCorporationIDStructuresStructureIDReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	...
	return result.(*PutCorporationsCorporationIDStructuresStructureIDNoContent), nil
