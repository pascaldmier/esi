...
// WithXUserAgent adds the xUserAgent to the get characters character id mail labels params
func (o *GetCharactersCharacterIDMailLabelsParams) WithXUserAgent(xUserAgent *string) *GetCharactersCharacterIDMailLabelsParams {
	o.SetXUserAgent(xUserAgent)
	return o
}

// SetXUserAgent adds the xUserAgent to the get characters character id mail labels params
func (o *GetCharactersCharacterIDMailLabelsParams) SetXUserAgent(xUserAgent *string) {
...
// WithUserAgent adds the userAgent to the get characters character id mail labels params
func (o *GetCharactersCharacterIDMailLabelsParams) WithUserAgent(userAgent *string) *GetCharactersCharacterIDMailLabelsParams {
	o.SetUserAgent(userAgent)
	return o
}

// SetUserAgent adds the userAgent to the get characters character id mail labels params
func (o *GetCharactersCharacterIDMailLabelsParams) SetUserAgent(userAgent *string) {
