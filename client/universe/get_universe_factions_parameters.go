...
// WithXUserAgent adds the xUserAgent to the get universe factions params
func (o *GetUniverseFactionsParams) WithXUserAgent(xUserAgent *string) *GetUniverseFactionsParams {
	o.SetXUserAgent(xUserAgent)
	return o
}

// SetXUserAgent adds the xUserAgent to the get universe factions params
func (o *GetUniverseFactionsParams) SetXUserAgent(xUserAgent *string) {
...
// WithUserAgent adds the userAgent to the get universe factions params
func (o *GetUniverseFactionsParams) WithUserAgent(userAgent *string) *GetUniverseFactionsParams {
	o.SetUserAgent(userAgent)
	return o
}

// SetUserAgent adds the userAgent to the get universe factions params
func (o *GetUniverseFactionsParams) SetUserAgent(userAgent *string) {
