...
// WithXUserAgent adds the xUserAgent to the get characters character id calendar event id params
func (o *GetCharactersCharacterIDCalendarEventIDParams) WithXUserAgent(xUserAgent *string) *GetCharactersCharacterIDCalendarEventIDParams {
	o.SetXUserAgent(xUserAgent)
	return o
}

// SetXUserAgent adds the xUserAgent to the get characters character id calendar event id params
func (o *GetCharactersCharacterIDCalendarEventIDParams) SetXUserAgent(xUserAgent *string) {
...
// WithUserAgent adds the userAgent to the get characters character id calendar event id params
func (o *GetCharactersCharacterIDCalendarEventIDParams) WithUserAgent(userAgent *string) *GetCharactersCharacterIDCalendarEventIDParams {
	o.SetUserAgent(userAgent)
	return o
}

// SetUserAgent adds the userAgent to the get characters character id calendar event id params
func (o *GetCharactersCharacterIDCalendarEventIDParams) SetUserAgent(userAgent *string) {
