...
// NewGetCharactersCharacterIDWalletsParamsWithHTTPClient creates a new GetCharactersCharacterIDWalletsParams object
// with the default values initialized, and the ability to set a custom HTTPClient for a request
func NewGetCharactersCharacterIDWalletsParamsWithHTTPClient(client *http.Client) *GetCharactersCharacterIDWalletsParams {
	var (
		datasourceDefault = string("tranquility")
	)
	return &GetCharactersCharacterIDWalletsParams{
...
// WithHTTPClient adds the HTTPClient to the get characters character id wallets params
func (o *GetCharactersCharacterIDWalletsParams) WithHTTPClient(client *http.Client) *GetCharactersCharacterIDWalletsParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the get characters character id wallets params
func (o *GetCharactersCharacterIDWalletsParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithXUserAgent adds the xUserAgent to the get characters character id wallets params
func (o *GetCharactersCharacterIDWalletsParams) WithXUserAgent(xUserAgent *string) *GetCharactersCharacterIDWalletsParams {
	o.SetXUserAgent(xUserAgent)
	return o
}

// SetXUserAgent adds the xUserAgent to the get characters character id wallets params
func (o *GetCharactersCharacterIDWalletsParams) SetXUserAgent(xUserAgent *string) {
...
// WithToken adds the token to the get characters character id wallets params
func (o *GetCharactersCharacterIDWalletsParams) WithToken(token *string) *GetCharactersCharacterIDWalletsParams {
	o.SetToken(token)
	return o
}

// SetToken adds the token to the get characters character id wallets params
func (o *GetCharactersCharacterIDWalletsParams) SetToken(token *string) {
	o.Token = token
}

// WithUserAgent adds the userAgent to the get characters character id wallets params
func (o *GetCharactersCharacterIDWalletsParams) WithUserAgent(userAgent *string) *GetCharactersCharacterIDWalletsParams {
	o.SetUserAgent(userAgent)
	return o
}

// SetUserAgent adds the userAgent to the get characters character id wallets params
func (o *GetCharactersCharacterIDWalletsParams) SetUserAgent(userAgent *string) {
