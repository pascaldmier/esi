...
// WithXUserAgent adds the xUserAgent to the get opportunities tasks task id params
func (o *GetOpportunitiesTasksTaskIDParams) WithXUserAgent(xUserAgent *string) *GetOpportunitiesTasksTaskIDParams {
	o.SetXUserAgent(xUserAgent)
	return o
}

// SetXUserAgent adds the xUserAgent to the get opportunities tasks task id params
func (o *GetOpportunitiesTasksTaskIDParams) SetXUserAgent(xUserAgent *string) {
...
// WithUserAgent adds the userAgent to the get opportunities tasks task id params
func (o *GetOpportunitiesTasksTaskIDParams) WithUserAgent(userAgent *string) *GetOpportunitiesTasksTaskIDParams {
	o.SetUserAgent(userAgent)
	return o
}

// SetUserAgent adds the userAgent to the get opportunities tasks task id params
func (o *GetOpportunitiesTasksTaskIDParams) SetUserAgent(userAgent *string) {
