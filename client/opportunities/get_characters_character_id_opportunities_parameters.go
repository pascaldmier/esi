...
// WithXUserAgent adds the xUserAgent to the get characters character id opportunities params
func (o *GetCharactersCharacterIDOpportunitiesParams) WithXUserAgent(xUserAgent *string) *GetCharactersCharacterIDOpportunitiesParams {
	o.SetXUserAgent(xUserAgent)
	return o
}

// SetXUserAgent adds the xUserAgent to the get characters character id opportunities params
func (o *GetCharactersCharacterIDOpportunitiesParams) SetXUserAgent(xUserAgent *string) {
...
// WithUserAgent adds the userAgent to the get characters character id opportunities params
func (o *GetCharactersCharacterIDOpportunitiesParams) WithUserAgent(userAgent *string) *GetCharactersCharacterIDOpportunitiesParams {
	o.SetUserAgent(userAgent)
	return o
}

// SetUserAgent adds the userAgent to the get characters character id opportunities params
func (o *GetCharactersCharacterIDOpportunitiesParams) SetUserAgent(userAgent *string) {
