...
// WithXUserAgent adds the xUserAgent to the get characters character id planets planet id params
func (o *GetCharactersCharacterIDPlanetsPlanetIDParams) WithXUserAgent(xUserAgent *string) *GetCharactersCharacterIDPlanetsPlanetIDParams {
	o.SetXUserAgent(xUserAgent)
	return o
}

// SetXUserAgent adds the xUserAgent to the get characters character id planets planet id params
func (o *GetCharactersCharacterIDPlanetsPlanetIDParams) SetXUserAgent(xUserAgent *string) {
...
// WithUserAgent adds the userAgent to the get characters character id planets planet id params
func (o *GetCharactersCharacterIDPlanetsPlanetIDParams) WithUserAgent(userAgent *string) *GetCharactersCharacterIDPlanetsPlanetIDParams {
	o.SetUserAgent(userAgent)
	return o
}

// SetUserAgent adds the userAgent to the get characters character id planets planet id params
func (o *GetCharactersCharacterIDPlanetsPlanetIDParams) SetUserAgent(userAgent *string) {
