...
// WithXUserAgent adds the xUserAgent to the get industry facilities params
func (o *GetIndustryFacilitiesParams) WithXUserAgent(xUserAgent *string) *GetIndustryFacilitiesParams {
	o.SetXUserAgent(xUserAgent)
	return o
}

// SetXUserAgent adds the xUserAgent to the get industry facilities params
func (o *GetIndustryFacilitiesParams) SetXUserAgent(xUserAgent *string) {
...
// WithUserAgent adds the userAgent to the get industry facilities params
func (o *GetIndustryFacilitiesParams) WithUserAgent(userAgent *string) *GetIndustryFacilitiesParams {
	o.SetUserAgent(userAgent)
	return o
}

// SetUserAgent adds the userAgent to the get industry facilities params
func (o *GetIndustryFacilitiesParams) SetUserAgent(userAgent *string) {
