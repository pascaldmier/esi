...
// WithXUserAgent adds the xUserAgent to the get characters character id clones params
func (o *GetCharactersCharacterIDClonesParams) WithXUserAgent(xUserAgent *string) *GetCharactersCharacterIDClonesParams {
	o.SetXUserAgent(xUserAgent)
	return o
}

// SetXUserAgent adds the xUserAgent to the get characters character id clones params
func (o *GetCharactersCharacterIDClonesParams) SetXUserAgent(xUserAgent *string) {
...
// WithUserAgent adds the userAgent to the get characters character id clones params
func (o *GetCharactersCharacterIDClonesParams) WithUserAgent(userAgent *string) *GetCharactersCharacterIDClonesParams {
	o.SetUserAgent(userAgent)
	return o
}

// SetUserAgent adds the userAgent to the get characters character id clones params
func (o *GetCharactersCharacterIDClonesParams) SetUserAgent(userAgent *string) {
