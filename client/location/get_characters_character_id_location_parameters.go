...
// WithXUserAgent adds the xUserAgent to the get characters character id location params
func (o *GetCharactersCharacterIDLocationParams) WithXUserAgent(xUserAgent *string) *GetCharactersCharacterIDLocationParams {
	o.SetXUserAgent(xUserAgent)
	return o
}

// SetXUserAgent adds the xUserAgent to the get characters character id location params
func (o *GetCharactersCharacterIDLocationParams) SetXUserAgent(xUserAgent *string) {
...
// WithUserAgent adds the userAgent to the get characters character id location params
func (o *GetCharactersCharacterIDLocationParams) WithUserAgent(userAgent *string) *GetCharactersCharacterIDLocationParams {
	o.SetUserAgent(userAgent)
	return o
}

// SetUserAgent adds the userAgent to the get characters character id location params
func (o *GetCharactersCharacterIDLocationParams) SetUserAgent(userAgent *string) {
