...
// WithXUserAgent adds the xUserAgent to the get wars war id params
func (o *GetWarsWarIDParams) WithXUserAgent(xUserAgent *string) *GetWarsWarIDParams {
	o.SetXUserAgent(xUserAgent)
	return o
}

// SetXUserAgent adds the xUserAgent to the get wars war id params
func (o *GetWarsWarIDParams) SetXUserAgent(xUserAgent *string) {
...
// WithUserAgent adds the userAgent to the get wars war id params
func (o *GetWarsWarIDParams) WithUserAgent(userAgent *string) *GetWarsWarIDParams {
	o.SetUserAgent(userAgent)
	return o
}

// SetUserAgent adds the userAgent to the get wars war id params
func (o *GetWarsWarIDParams) SetUserAgent(userAgent *string) {
