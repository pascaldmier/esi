...
func (o *PostCharactersCharacterIDCspaParams) WithCharacters(characters *models.PostCharactersCharacterIDCspaParamsBody) *PostCharactersCharacterIDCspaParams {
	o.SetCharacters(characters)
	return o
}

// SetCharacters adds the characters to the post characters character id cspa params
func (o *PostCharactersCharacterIDCspaParams) SetCharacters(characters *models.PostCharactersCharacterIDCspaParamsBody) {
...
func (o *PostCharactersCharacterIDCspaParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Characters == nil {
		o.Characters = new(models.PostCharactersCharacterIDCspaParamsBody)
	}
