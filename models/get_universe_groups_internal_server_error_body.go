...
func (m *GetUniverseGroupsInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetUniverseGroupsInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetUniverseGroupsInternalServerErrorBody) UnmarshalBinary(b []byte) error {
	var res GetUniverseGroupsInternalServerErrorBody
