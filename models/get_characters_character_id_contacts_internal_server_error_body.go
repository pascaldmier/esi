...
func (m *GetCharactersCharacterIDContactsInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCharactersCharacterIDContactsInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetCharactersCharacterIDContactsInternalServerErrorBody) UnmarshalBinary(b []byte) error {
