...
func (m *GetCharactersCharacterIDMailListsForbiddenBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCharactersCharacterIDMailListsForbiddenBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetCharactersCharacterIDMailListsForbiddenBody) UnmarshalBinary(b []byte) error {
	var res GetCharactersCharacterIDMailListsForbiddenBody
