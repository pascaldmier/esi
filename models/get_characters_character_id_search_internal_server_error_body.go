...
func (m *GetCharactersCharacterIDSearchInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCharactersCharacterIDSearchInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetCharactersCharacterIDSearchInternalServerErrorBody) UnmarshalBinary(b []byte) error {
	var res GetCharactersCharacterIDSearchInternalServerErrorBody
