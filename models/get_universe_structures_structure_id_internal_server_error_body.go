...
func (m *GetUniverseStructuresStructureIDInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetUniverseStructuresStructureIDInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetUniverseStructuresStructureIDInternalServerErrorBody) UnmarshalBinary(b []byte) error {
	var res GetUniverseStructuresStructureIDInternalServerErrorBody
