...
func (m *PostCharactersCharacterIDMailLabelsInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostCharactersCharacterIDMailLabelsInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PostCharactersCharacterIDMailLabelsInternalServerErrorBody) UnmarshalBinary(b []byte) error {
	var res PostCharactersCharacterIDMailLabelsInternalServerErrorBody
