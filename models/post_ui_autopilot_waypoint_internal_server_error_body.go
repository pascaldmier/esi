...
func (m *PostUIAutopilotWaypointInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostUIAutopilotWaypointInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PostUIAutopilotWaypointInternalServerErrorBody) UnmarshalBinary(b []byte) error {
