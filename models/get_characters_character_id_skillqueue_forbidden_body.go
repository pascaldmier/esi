...
func (m *GetCharactersCharacterIDSkillqueueForbiddenBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCharactersCharacterIDSkillqueueForbiddenBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetCharactersCharacterIDSkillqueueForbiddenBody) UnmarshalBinary(b []byte) error {
