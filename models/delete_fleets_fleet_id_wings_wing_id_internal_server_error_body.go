...
func (m *DeleteFleetsFleetIDWingsWingIDInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteFleetsFleetIDWingsWingIDInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *DeleteFleetsFleetIDWingsWingIDInternalServerErrorBody) UnmarshalBinary(b []byte) error {
	var res DeleteFleetsFleetIDWingsWingIDInternalServerErrorBody
