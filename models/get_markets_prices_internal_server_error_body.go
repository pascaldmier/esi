...
func (m *GetMarketsPricesInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMarketsPricesInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetMarketsPricesInternalServerErrorBody) UnmarshalBinary(b []byte) error {
