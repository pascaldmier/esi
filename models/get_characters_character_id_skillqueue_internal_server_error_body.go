...
func (m *GetCharactersCharacterIDSkillqueueInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCharactersCharacterIDSkillqueueInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetCharactersCharacterIDSkillqueueInternalServerErrorBody) UnmarshalBinary(b []byte) error {
