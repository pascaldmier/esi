...
func (m *GetSearchInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetSearchInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetSearchInternalServerErrorBody) UnmarshalBinary(b []byte) error {
	var res GetSearchInternalServerErrorBody
