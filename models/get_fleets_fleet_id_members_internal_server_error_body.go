...
func (m *GetFleetsFleetIDMembersInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetFleetsFleetIDMembersInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetFleetsFleetIDMembersInternalServerErrorBody) UnmarshalBinary(b []byte) error {
	var res GetFleetsFleetIDMembersInternalServerErrorBody
