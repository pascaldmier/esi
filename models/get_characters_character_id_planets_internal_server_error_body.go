...
func (m *GetCharactersCharacterIDPlanetsInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCharactersCharacterIDPlanetsInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetCharactersCharacterIDPlanetsInternalServerErrorBody) UnmarshalBinary(b []byte) error {
	var res GetCharactersCharacterIDPlanetsInternalServerErrorBody
