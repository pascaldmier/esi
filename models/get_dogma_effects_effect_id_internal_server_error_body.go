...
func (m *GetDogmaEffectsEffectIDInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDogmaEffectsEffectIDInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetDogmaEffectsEffectIDInternalServerErrorBody) UnmarshalBinary(b []byte) error {
