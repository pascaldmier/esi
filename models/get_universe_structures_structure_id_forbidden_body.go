...
func (m *GetUniverseStructuresStructureIDForbiddenBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetUniverseStructuresStructureIDForbiddenBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetUniverseStructuresStructureIDForbiddenBody) UnmarshalBinary(b []byte) error {
	var res GetUniverseStructuresStructureIDForbiddenBody
