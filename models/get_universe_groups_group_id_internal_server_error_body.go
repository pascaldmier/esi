...
func (m *GetUniverseGroupsGroupIDInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetUniverseGroupsGroupIDInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetUniverseGroupsGroupIDInternalServerErrorBody) UnmarshalBinary(b []byte) error {
	var res GetUniverseGroupsGroupIDInternalServerErrorBody
