...
func (m *PostUIOpenwindowContractInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostUIOpenwindowContractInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PostUIOpenwindowContractInternalServerErrorBody) UnmarshalBinary(b []byte) error {
