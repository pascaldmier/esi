...
func (m *GetCharactersCharacterIDIndustryJobsForbiddenBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCharactersCharacterIDIndustryJobsForbiddenBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetCharactersCharacterIDIndustryJobsForbiddenBody) UnmarshalBinary(b []byte) error {
