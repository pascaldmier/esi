...
func (m *GetIncursionsInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIncursionsInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetIncursionsInternalServerErrorBody) UnmarshalBinary(b []byte) error {
	var res GetIncursionsInternalServerErrorBody
