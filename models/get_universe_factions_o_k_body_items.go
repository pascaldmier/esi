...
func (m *GetUniverseFactionsOKBodyItems) validateCorporationID(formats strfmt.Registry) error {
...
func (m *GetUniverseFactionsOKBodyItems) validateSolarSystemID(formats strfmt.Registry) error {
