...
func (m *GetCharactersCharacterIDMailLabelsForbiddenBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCharactersCharacterIDMailLabelsForbiddenBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetCharactersCharacterIDMailLabelsForbiddenBody) UnmarshalBinary(b []byte) error {
	var res GetCharactersCharacterIDMailLabelsForbiddenBody
